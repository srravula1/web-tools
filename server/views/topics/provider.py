...
def topic_provider_stories_csv(topics_id):
    ...
    # we do this do make sure this helper can page through the results (because this is a download request)
    if 'link_id' in optional_args:
        del optional_args['link_id']
